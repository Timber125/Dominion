 ...
 * @author Emiel
 */
public class WampDatabaseServiceTest{
    private Server server;
    private WampMYSQLDatabaseService instance;
    
    public WampDatabaseServiceTest() {
        this.server = new Server("localhost", 13337, 13338);
        this.instance = new WampMYSQLDatabaseService(server);
    }
