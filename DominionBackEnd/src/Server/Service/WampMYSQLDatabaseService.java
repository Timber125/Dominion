 ...
 * @author Emiel
 */
public class WampMYSQLDatabaseService extends Service {
    private Connection connection;
    
    public WampMYSQLDatabaseService(Server server){
        super(server);
    ...
    protected int getIdOfPlayer(String username)throws SQLException{
         try{
